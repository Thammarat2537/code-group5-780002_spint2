...
<body>
    ...
    <div class="limiter">
        <div class="container-login100">
			...
			<form method="post" action="payment.php?totalprice=<?php echo $totalprice; ?>&totalsub=<?php echo $sub; ?>&totalvat=<?php echo $tax; ?>" class="login100-form validate-form">
		
                    <span class="login100-form-title p-b-34">
							รายละเอียดจัดส่ง
                    </span>
					<input type="hidden" name="grandtotal" value="<?php echo $totalprice; ?>">
					<input type="hidden" name="getsub" value="<?php echo $sub; ?>">
					<input type="hidden" name="gettax" value="<?php echo $tax; ?>">
